...
- Prefer `bun run <script>` over invoking tool binaries directly so local runs match CI behavior.
...
- **Bun exclusively for dependency management and scripts**; use Node 24 for utility scripts and Bun for tests
